...
class Historiale(models.Model):
    ...
    id_estado= models.IntegerField(verbose_name='id del estado')
...
class Tecnico(models.Model):
    id_usuario_c= models.IntegerField(primary_key=True,verbose_name='id_usuario_c')
    ...
    id_usuario_t= models.IntegerField(verbose_name='id_usuario_t')
...
class Detalle(models.Model):
    ...
    id_st= models.IntegerField(verbose_name='id_st')
    id_servicio= models.IntegerField(verbose_name='id servicio')
...
class Equipo(models.Model):
    ...
    id_tipo = models.IntegerField(verbose_name='id tipo')
